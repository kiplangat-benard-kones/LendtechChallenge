...
import com.challenge.lendtech.database.LogData;
        ...
        while (true) {
            try {
                ...
                if(elevator.queueDown.isEmpty() && elevator.queueUp.isEmpty()){
                    ...
                    new LogData().insertLogData("1", "Door opening", "Elevator Reached at "+elevator.targetFloor+" ***\nDoor Opening...\n");
					System.out.println( "Elevator{" +
							...
							"\n");
                    new LogData().insertLogData("1", "Elevator moving", "Elevator at "+elevator.currentfloor +" and going "+elevator.direction);
